...
//відсортувавши їх за прізвищами студентів в абетковому порядку. Визначити двох студентів з найвищим середнім рейтинговим 
//балом.
#include"stdafx.h"
#include <string.h>
#include<iomanip>
...
Student *x=new Student[n];           //заносимо дані у ДП
...
{ 
	...
	x[i].GPA=(double)sum/ns;       //знаходимо середній рейтинговий бал
}
// знаходимо 2 студентів з найвищим GPA
int imax=0, iprev=0;
for(int j=1; j<n; j++){
...
void sort_GPA(Student *p, int n)		// сортує за прізвищами в абетковому порядку(методом бульбашки)
{
int i,j;
Student y;
for(i=n-1;i>0;i--)
